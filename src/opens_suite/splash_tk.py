...
def main():
    ...
    if os.path.exists(logo_path):
        try:
            ...
            tk.Label(root, text="OpenS", font=("Arial", 24, "bold"), bg="#ffffff").pack(
                pady=20
            )
    else:
        tk.Label(root, text="OpenS", font=("Arial", 24, "bold"), bg="#ffffff").pack(
    ...
    # App Name
    name_label = tk.Label(
        root, text="OpenS", font=("Arial", 20, "bold"), bg="#ffffff", fg="#1f1f1f"
    )
    name_label.pack()

    # Author
    author_label = tk.Label(
        root, text="by Florian Seim", font=("Arial", 12), bg="#ffffff", fg="#888888"
    )
    author_label.pack(pady=(0, 10))

    # Status Label
    status_label = tk.Label(
        root, text="Loading...", font=("Arial", 11), bg="#ffffff", fg="#444444"
    )
    ...
    progress = ttk.Progressbar(
        root, length=240, mode="determinate", style="TProgressbar"
    )
